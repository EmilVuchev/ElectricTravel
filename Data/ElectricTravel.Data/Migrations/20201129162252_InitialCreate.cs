        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    KilowattHour = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Acceleration = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    TopSpeed = table.Column<double>(type: "float", nullable: false),
                    Battery = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ElectricityConsumption = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Seats = table.Column<int>(type: "int", nullable: false),
                    SmokeRestriction = table.Column<bool>(type: "bit", nullable: false),
                    PlaceForLuggage = table.Column<bool>(type: "bit", nullable: false),
                    WithReturnTrip = table.Column<bool>(type: "bit", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    TypeOfTravelId = table.Column<int>(type: "int", nullable: false),
